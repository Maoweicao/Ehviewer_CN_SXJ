...
public class DaoSession extends AbstractDaoSession {
    ...
    private final DaoConfig ptokensIndexDaoConfig;
    private final DaoConfig systemDownloadTaskDaoConfig;
    private final DaoConfig downloadHistoryDaoConfig;
    private final DaoConfig galleryAiInfoDaoConfig;
    ...
    private final PtokensIndexDao ptokensIndexDao;
    private final SystemDownloadTaskDao systemDownloadTaskDao;
    private final DownloadHistoryDao downloadHistoryDao;
    private final GalleryAiInfoDao galleryAiInfoDao;
    ...
    public DaoSession(Database db, IdentityScopeType type, Map<Class<? extends AbstractDao<?, ?>>, DaoConfig>
        ...
        ptokensIndexDaoConfig = daoConfigMap.get(PtokensIndexDao.class).clone();
        ptokensIndexDaoConfig.initIdentityScope(type);

        systemDownloadTaskDaoConfig = daoConfigMap.get(SystemDownloadTaskDao.class).clone();
        systemDownloadTaskDaoConfig.initIdentityScope(type);

        downloadHistoryDaoConfig = daoConfigMap.get(DownloadHistoryDao.class).clone();
        downloadHistoryDaoConfig.initIdentityScope(type);

        galleryAiInfoDaoConfig = daoConfigMap.get(GalleryAiInfoDao.class).clone();
        galleryAiInfoDaoConfig.initIdentityScope(type);
        ...
        ptokensIndexDao = new PtokensIndexDao(ptokensIndexDaoConfig, this);
        systemDownloadTaskDao = new SystemDownloadTaskDao(systemDownloadTaskDaoConfig, this);
        downloadHistoryDao = new DownloadHistoryDao(downloadHistoryDaoConfig, this);
        galleryAiInfoDao = new GalleryAiInfoDao(galleryAiInfoDaoConfig, this);
        ...
        registerDao(MilestoneInfo.class, milestoneDao);
        registerDao(PtokensIndex.class, ptokensIndexDao);
        registerDao(SystemDownloadTask.class, systemDownloadTaskDao);
        registerDao(DownloadHistory.class, downloadHistoryDao);
        registerDao(GalleryAiInfo.class, galleryAiInfoDao);
    }
    ...
    public void clear() {
        ...
        ptokensIndexDaoConfig.getIdentityScope().clear();
        systemDownloadTaskDaoConfig.getIdentityScope().clear();
        downloadHistoryDaoConfig.getIdentityScope().clear();
        galleryAiInfoDaoConfig.getIdentityScope().clear();
    }
    ...
    public PtokensIndexDao getPtokensIndexDao() {
        return ptokensIndexDao;
    }

    public SystemDownloadTaskDao getSystemDownloadTaskDao() {
        return systemDownloadTaskDao;
    }
    ...
    public GalleryAiInfoDao getGalleryAiInfoDao() {
        return galleryAiInfoDao;
    }
